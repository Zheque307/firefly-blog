...
export const siteConfig: SiteConfig = {
	...
	// 站点副标题
	subtitle: "愿你我都如星火，照亮彼此",

	// 站点 URL
	// 注意：绑定域名后请改成 https://你的域名
	site_url: "https://121.199.28.136",

	// 站点描述
	description:
		"这里是折鹊的个人小站，记录生活、折腾与热爱。愿你我都如星火，照亮彼此。",

	// 站点关键词
	keywords: ["折鹊", "个人博客", "生活记录", "ACGN", "随笔"],
	...
	mal: {
		...
		// 该页面默认关闭（见页面开关 pages.mal），如需启用请填自己的用户名
		username: "",
